            ...
            <div class="col-md-12 px-0">
                    <div class="row">
                        <div class="col-md-4 px-0 content-menu">
                            <div class="post-meta">
                            <h5>STORIES / <strong> <?php echo get_the_terms($post,'story_category')[0]->name; ?></strong></h5>
                            <p class="mt-4">RO / <?php echo get_the_terms($post,'story_location')[0]->name . ' / ' . get_the_date() ?></p>
